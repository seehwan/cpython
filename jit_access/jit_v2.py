...
# following code invalidates jit execution for test_function
jit_code = jitaccess.get_executor_code_address(test_function, 98)
print("jit code found: ", (jit_code))

try:
    test_function()
except Exception as e:
    print(e)
    print("test_function() failed as expected")
